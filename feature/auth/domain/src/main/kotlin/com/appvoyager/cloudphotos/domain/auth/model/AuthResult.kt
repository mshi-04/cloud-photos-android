...
fun <T> AuthResult<T>.errorOrNull(): AuthError? = (this as? AuthResult.Error)?.error
...
inline fun <T, R> AuthResult<T>.flatMap(transform: (T) -> AuthResult<R>): AuthResult<R> = when (this) {
